 ...
 * @returns {object}
 */
const singleToArray = (jsonObject, path) => {
    ...
    if (currentFieldIsArray) {
        ...
        jsonResult[currentField].forEach((arrayEntry, index) => {
            ...
            jsonResult[currentField][index] = singleToArray(
    ...
    if (nextField !== null) {
        ...
        jsonResult[currentField] = convertSingleToArray(jsonResult[currentField], nextPath);
    } else {
